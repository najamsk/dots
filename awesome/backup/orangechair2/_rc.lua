...
-- {{{ Tags
 ...
 tags = {
   names  = { "main", "www", "dev", "gimp", "steam", "aux" },
...
mymainmenu = awful.menu({ items = { { "APPS" },
                                    { "files", "pcmanfm" },
                                    { "calc", "galculator" },
...
for s = 1, screen.count() do
    ...
    -- Create the wibox & ADJUST HEIGHT HERE
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "d", 	   function () awful.util.spawn("atom")  end),
...
awful.rules.rules = {
    ...
    -- Gcal Small Calendar
    --{ rule = { class = "gcal" }, properties = { width = 100, height = 100 } },
